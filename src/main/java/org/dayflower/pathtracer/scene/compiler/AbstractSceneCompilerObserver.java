 ...
 * <p>
 * You may extend this class if you only want to override some of the methods in {@code SceneCompilerObserver}.
 * 
 * @since 1.0.0
 * @author J&#246;rgen Lundgren
 */
public abstract class AbstractSceneCompilerObserver implements SceneCompilerObserver {
	/**
	 * Constructs a new {@code AbstractSceneCompilerObserver} instance.
	 */
