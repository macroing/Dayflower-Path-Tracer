/**
 * Provides {@link org.dayflower.pathtracer.scene.Texture Texture} implementations.
 * <p>
 * The {@code Texture}s that are currently supported are the following:
 * <ul>
 * <li>{@link org.dayflower.pathtracer.scene.texture.CheckerboardTexture CheckerboardTexture} - An implementation of a checkerboard texture.</li>
 * <li>{@link org.dayflower.pathtracer.scene.texture.ConstantTexture ConstantTexture} - An implementation of a constant texture.</li>
