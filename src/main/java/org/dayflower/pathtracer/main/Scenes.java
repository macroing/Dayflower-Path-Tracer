...
//			final Texture texture5 = new CheckerboardTexture(Color.CYAN);
			...
			final List<Triangle> triangles = mesh.getTriangles(texture1, texture8);
...
//			Floor.
			scene.addShape(new Plane(Color.BLACK, 0.0F, 0.0F, Material.METAL, texture9, texture10, new Point3(0.0F, 0.0F, 0.0F), new Point3(1.0F, 0.0F, 0.0F), new Point3(0.0F, 0.0F, 1.0F)));
//			Roof.
